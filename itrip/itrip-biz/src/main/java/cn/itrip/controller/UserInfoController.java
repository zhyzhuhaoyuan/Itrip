...
public class UserInfoController {
    ...
    @ResponseBody
    public cn.itrip.beans.dto.Dto adduserlinkuser(@RequestBody ItripAddUserLinkUserVO itripAddUserLinkUserVO, HttpServletRequest request) {
        String tokenString = request.getHeader("token");
        logger.info("tokenString>>>>>>>>>>>>>" + tokenString);
    ...
    @ResponseBody
    public cn.itrip.beans.dto.Dto deluserlinkuser(@RequestParam Long[] ids, HttpServletRequest request) {
        String tokenString = request.getHeader("token");
        logger.info("tokenString>>>>>>>>>>>>>" + tokenString);
        logger.info("id>>>>>>>>>>>>>" + ids);
        ItripUser currentUser = validationToken.getCurrentUser(tokenString);
    ...
    @ResponseBody
    public cn.itrip.beans.dto.Dto getItripUserLinkUserById(@RequestBody ItripModifyUserLinkUserVO itripModifyUserLinkUserVO, HttpServletRequest request) {
        String tokenString = request.getHeader("token");
        logger.info("tokenString>>>>>>>>>>>>>" + tokenString);
    ...
    @ResponseBody
    public cn.itrip.beans.dto.Dto modifyuserlinkuser(@RequestBody ItripModifyUserLinkUserVO itripModifyUserLinkUserVO, HttpServletRequest request) {
        String tokenString = request.getHeader("token");
        logger.info("tokenString>>>>>>>>>>>>>" + tokenString);
