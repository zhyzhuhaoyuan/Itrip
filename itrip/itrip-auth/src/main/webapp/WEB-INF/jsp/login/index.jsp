...
<form action="/authDemo/api/dologin"
    ...
    <div>
        ...
        <a href="${pageContext.request.contextPath}/api/registerIndex.html">邮箱注册</a>
        <a href="${pageContext.request.contextPath}/api/registerSmsUser.html">短信注册</a>
        <a href="http://5541f2da.ngrok.io/${pageContext.request.contextPath}/WeCat/login">微信登入</a>
